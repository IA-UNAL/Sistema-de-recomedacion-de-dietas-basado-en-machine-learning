...
def train_mlp(data_path='diet_data.xlsx'):
    """
    ...
    mlp_model = MLPClassifier(hidden_layer_sizes=(128,64), alpha=0.1, learning_rate_init=0.01, random_state=42)  # CONFIGURACIÓN DEL MLP
    ...
    joblib.dump(mlp_model, 'diet_recommendation_model.pkl')
    joblib.dump(label_encoders, 'label_encoders.pkl')

    return mlp_model, label_encoders, features
...
def main():
    try:
        ...
        model, label_encoders, features = train_mlp()
