...
def plot_confusion_matrix(y_true, y_pred, classes):
    ...
    plt.tight_layout()
    plt.savefig('confusion_matrix_light.png')
    plt.close()
...
def train_diet_recommendation_model(data_path='diet_data.xlsx',model_name='LightGBM'):
    ...
    #joblib.dump(lgb_model, 'diet_recommendation_model_ligbm.pkl')
    #joblib.dump(label_encoders, 'label_encoders_ligbm.pkl')
...
def main():
    try:
        ...
        model = joblib.load('diet_recommendation_model_ligbm.pkl')
        label_encoders = joblib.load('label_encoders_ligbm.pkl')
        features = ['Sex_Male', 'Age', 'Height', 'Weight', 'Hypertension', 
                    'Diabetes_Yes', 'BMI', 'Level', 'Fitness Goal', 'Fitness Type']
