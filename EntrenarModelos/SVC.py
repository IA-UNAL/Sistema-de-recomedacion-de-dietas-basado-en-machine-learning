...
def train_diet_recommendation_model(data_path='diet_data.xlsx',model_name='Support Vector Classification'):
    ...
    #joblib.dump(svc_model, 'diet_recommendation_model_svc.pkl')
    #joblib.dump(label_encoders, 'label_encoders_svc.pkl')
...
def main():
    try:
        ...
        model = joblib.load('diet_recommendation_model_svc.pkl')
