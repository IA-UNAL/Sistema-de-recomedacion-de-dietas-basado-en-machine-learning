...
def train_diet_recommendation_model(data_path='diet_data.xlsx',model_name='XGBoost'):
    ...
    #joblib.dump(xgb_model, 'diet_recommendation_model_xgb.pkl')
    #joblib.dump(label_encoders, 'label_encoders_xgb.pkl')
    ...
    return fpr, tpr, roc_auc, model_name , xgb_model, label_encoders, features
...
def main():
    try:
        ...
        model = joblib.load('diet_recommendation_model_xgb.pkl')
